...
public class ArvoreAVL{
	...
	public static class No {
		...
		*/
		public No(Musica elemento, No esq, No dir, int nivel) {
	...
	*/
    ...
    public static void main(String[] args) throws IOException {
			...
			for(int i = 0; i < entrada2.size(); i++){
				for(int j = 0; j < QntMusica; j++){
					if(musica[j].getId().equals(entrada2.get(i))){
						if(avl.pesquisar(musica[j]) == true){
		...
		BufferedWriter log = new BufferedWriter(new FileWriter("matricula_avl.txt"));
