...
public class HashRehash{
	...
	public static class Hash {
		...
		public int h(Musica elemento){
		   	return elemento.getDuration_ms() % m;
		}
	 
		public int reh(Musica elemento){
		   	return (elemento.getDuration_ms() +1 ) % m;
		}
	...
	*/
    ...
    public static void main(String[] args) throws IOException {
		...
		BufferedWriter log = new BufferedWriter(new FileWriter("matricula_hashRehash.txt"));
