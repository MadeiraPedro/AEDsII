...
public class ClasseJava{
	...
	*/
	 ...
	 * logo apos e feito a leitura da entrada padrao onde o valor lido retornara os dados do Musica em questao
	 * 
	 * @param args
    ...
    public static void main(String[] args) throws IOException {
		...
		while(!ehFIM(str)){
			...
			for(int i = 0; i < QntMusica; i++){
				if(str.equals(musica[i].getId())){
					System.out.println(musica[i].getId() +" ## "+ musica[i].getArtists() +" ## "+ musica[i].getName() +" ## "+ musica[i].getRelease_date() +" ## "+ musica[i].getAcousticness() +" ## "+ musica[i].getDanceability() +" ## "+ musica[i].getInstrumentalness() +" ## "+ musica[i].getLiveness() +" ## "+ musica[i].getLoudness() +" ## "+ musica[i].getSpeechiness() +" ## "+ musica[i].getEnergy() +" ## "+ musica[i].getDuration_ms());
					i = QntMusica;
				}
			}//fim for(i)
