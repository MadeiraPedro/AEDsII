...
public class CountingsortJava{
	...
	*/
    ...
    public static void main(String[] args) throws IOException {
		...
		int[] posicoes = new int[entrada.size()];
		...
		/*for(int i = 0; i < posicoes.length; i++){
			System.out.println(posicoes[i] + "  " + musica[posicoes[i]].getPopularity());
		}
		System.out.println("===================================================");*/

		//====================== sort ============================

		int maior = musica[posicoes[0]].getPopularity();
		int n = posicoes.length;

		for (int i = 0; i < n; i++) {
        	if(maior < musica[posicoes[i]].getPopularity()){
            maior = musica[posicoes[i]].getPopularity();
         	}
		}
		...
		for (int i = 0; i < n; count[musica[posicoes[i]].getPopularity()]++, i++); /////////////////////////////
  
		//Agora, o count[i] contem o numero de elemento menores ou iguais a i
		for(int i = 1; i < count.length; count[i] += count[i-1], i++);
  
		//Ordenando
		for(int i = n-1; i >= 0; ordenado[count[posicoes[i]]-1] = musica[posicoes[i]].getPopularity(), count[posicoes[i]]--, i--);
  
		//Copiando para o array original
		for(int i = 0; i < n; posicoes[i] = ordenado[i], i++);
	  ...
	  //===========================================================
		...
		/*for(int i = 0; i < posicoes.length; i++){
			System.out.println(musica[posicoes[i]].getId() +" ## "+ musica[posicoes[i]].getArtists() +" ## "+ musica[posicoes[i]].getName() +" ## "+ musica[posicoes[i]].getRelease_date() +" ## "+ musica[posicoes[i]].getAcousticness() +" ## "+ musica[posicoes[i]].getDanceability() +" ## "+ musica[posicoes[i]].getInstrumentalness() +" ## "+ musica[posicoes[i]].getLiveness() +" ## "+ musica[posicoes[i]].getLoudness() +" ## "+ musica[posicoes[i]].getSpeechiness() +" ## "+ musica[posicoes[i]].getEnergy() +" ## "+ musica[posicoes[i]].getDuration_ms());
		}//fim for(i)*/
